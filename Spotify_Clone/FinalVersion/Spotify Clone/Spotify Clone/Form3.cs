...
namespace Spotify_Clone
{
	...
	public partial class Video : Form
	{
		...
		private void Form3_Load(object sender,EventArgs e){timer1.Start();axWindowsMediaPlayer1.URL=Form1.CaMusica;axWindowsMediaPlayer1.settings.volume=int.Parse(Form1.Volume);OldMusic=axWindowsMediaPlayer1.URL;axWindowsMediaPlayer1.Ctlcontrols.play();this.Text=(Form1.NameMusic[(Form1.NameMusic.Length-1)].Substring(0,(Form1.NameMusic[(Form1.NameMusic.Length-1)].Count()-4)));AuxMusic.Interval=1;AuxMusic.Start();timer1.Stop();}
		private void AuxMusic_Tick(object sender,EventArgs e){if(axWindowsMediaPlayer1.playState==WMPLib.WMPPlayState.wmppsPlaying){progressBar1.Maximum=(int)axWindowsMediaPlayer1.Ctlcontrols.currentItem.duration;maxprogresso=axWindowsMediaPlayer1.Ctlcontrols.currentItem.duration;progressBar1.Value=(int)axWindowsMediaPlayer1.Ctlcontrols.currentPosition;progresso=(int)axWindowsMediaPlayer1.Ctlcontrols.currentPosition;}}
	}
}

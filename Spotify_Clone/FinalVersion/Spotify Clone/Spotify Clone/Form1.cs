...
namespace Spotify_Clone
{
	public partial class Form1 : Form
	{
		...
		private void timer2_Tick(object sender,EventArgs e){if(FormVideo==false)
			{
				dt++;

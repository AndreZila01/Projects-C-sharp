...
namespace Spotify_Clone
{
	...
	public partial class Form1 : Form
	{
		...
		private void pictureBox5_Click(object sender, EventArgs e)
		{
			...
			//{
			//	pE_Repit.Image = Properties.Resources.refresh__2_;
			//	pE_Repit.Tag = 1;
			//}
			//else
			//{
			//	pE_Repit.Image = Properties.Resources.refresh__3_;
			//	pE_Repit.Tag = 0;
			//}
		}
		...
		private void pE_Random_Click(object sender, EventArgs e)
		{
			...
			//		try
			//		{
			//			foreach (string a in _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica) Ordem_de_Reproducao.Add(0.0001);
			//			for (int d = 0;
			//			d < _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica.Count();
			//			d++)
			//			{
			//				aqui: Random rd = new Random();
			...
			//					pE_Random.Image = Properties.Resources.change_1;
			//				}
			//				else
			//				{
			//					goto aqui;
		...
		private void removeThePlayListToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			//	if (pictureBox2.Tag != null) if (int.Parse(pictureBox2.Tag.ToString()) == (int)tag.Tag)
			//		{
			//			PBC.Value = 0;
			//			labelControl2.Text = "";
			//			labelControl2.Tag = "";
			...
			//			}
			//		}
			//	if ((IdPlayList) == ((int)tag.Tag) && (int)pE_PauseaPlay.Tag != 0)
			//	{
			//		labelControl2.Text = "";
			//		IdPlayList = 0;
			//		PBC.Value = 0;
			...
			//	}
			//	IdPlayList = (int)tag.Tag;
			//	_listInformacoes.Remove(_listInformacoes.FirstOrDefault(row => row.IDList == (int)tag.Tag));
...
"\\"}, StringSplitOptions.None);
			...
			pe.Image = Properties.Resources.icons8_plus_500__1_;
			...
			pictureEdit.Image = Properties.Resources.expand__1_;
		...
		{
			PictureBox picture = sender as PictureBox;
			_listInformacoes[(IdPlayList - 1)].Caminho_da_Musica.RemoveAt(int.Parse(picture.Tag.ToString()));
			PlaydaLista.Clear();
			_listInformacoes[(IdPlayList - 1)].Caminho_da_Musica.ToList().ForEach(item =>
			{
				NameMusic = item.Split(new string[]{
...
//			try
//			{
//				NameMusic = _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica[((int)pe.Tag)].Split(new string[]{
//"\\"}, StringSplitOptions.None);
//				labelControl2.Text = NameMusic[NameMusic.Length - 1].Substring(0, (NameMusic[NameMusic.Length - 1].Count() - 4));
//			}
//			catch
...
//					NameMusic = _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica[(int)Ordem_de_Reproducao[(r)]].Split(new string[] {
// "\\" }, StringSplitOptions.None);
//				}
//				catch
//				{
//					axWindowsMediaPlayer1.URL = _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica[(int)Ordem_de_Reproducao[0]];
//					NameMusic = _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica[(int)Ordem_de_Reproducao[(0)]].Split(new string[] {
// "\\" }, StringSplitOptions.None);
//				}
//				int TAMANHO = NameMusic.Length;
...
//					axWindowsMediaPlayer1.URL = _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica[(int)Ordem_de_Reproducao[int.Parse(labelControl2.Tag.ToString())]];
//					NameMusic = _listInformacoes[(IdPlayList - 1)].Caminho_da_Musica[(int)Ordem_de_Reproducao[int.Parse(labelControl2.Tag.ToString())]].Split(new string[]{
//"\\"}, StringSplitOptions.None);
//					labelControl2.Text = NameMusic[NameMusic.Length - 1].Substring(0, (NameMusic[NameMusic.Length - 1].Count() - 4));
//					axWindowsMediaPlayer1.Ctlcontrols.play();
//					PBC.Value = 0;
...
//				}
//			}
//			else if ((PBC.Value == 0) && pE_PauseaPlay.Tag.ToString() != "1" && labelControl2.Text != string.Empty && (Ordem_de_Reproducao.Count() >= 1)) timer2.Start();
		}
...
//					}
//				}
//				else if (pE_PauseaPlay.Tag.ToString() == "1") dt = 0;
//			}
//			else
//			{
//				FormCollection fc = Application.OpenForms;
...
//						{
//							if (PBC.Tag != null && (PBC.Value == Video.maxprogresso)) if ((PBC.Value == Video.maxprogresso))
//								{

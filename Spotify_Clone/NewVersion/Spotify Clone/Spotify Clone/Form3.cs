...
namespace Spotify_Clone
{
	...
	public partial class Video : Form
	{
		...
		{
			timer1.Start();
			axWindowsMediaPlayer1.URL=Form1.CaMusica;axWindowsMediaPlayer1.settings.volume=int.Parse(Form1.Volume);
			OldMusic=axWindowsMediaPlayer1.URL;
		...
		private void axWindowsMediaPlayer1_DoubleClickEvent(object sender, AxWMPLib._WMPOCXEvents_DoubleClickEvent e)
		{
			switch (axWindowsMediaPlayer1.Tag)
			{
				...
				case "Diminuir":
					...
					Width = 729;
					Height = 450;
					Left = (Screen.PrimaryScreen.WorkingArea.Width) / 5;
					Top = (Screen.PrimaryScreen.WorkingArea.Height) / 5;

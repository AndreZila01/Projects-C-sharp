...
namespace Spotify_Clone
{
	...
	{
		public static string info; public static int progresso; public static double maxprogresso; string OldMusic; private const int CP_NOCLOSE_BUTTON = 0x200; public Video() { InitializeComponent(); }
		public void timer1_Tick(object sender, EventArgs e)
		{
			...
			{
				axWindowsMediaPlayer1.URL = Form1.CaMusica; OldMusic = axWindowsMediaPlayer1.URL;
				timer1.Stop();
			...
			switch (Form1.Processo) { case "start": axWindowsMediaPlayer1.Ctlcontrols.play(); AuxMusic.Stop(); pctPausa.Image = Properties.Resources.pauseB; AuxMusic.Start(); break; case "pause": axWindowsMediaPlayer1.Ctlcontrols.pause(); pctPausa.Image = Properties.Resources.playB; AuxMusic.Stop(); break; }
			if (progressBar1.Value == progressBar1.Maximum || progressBar1.Value == (progressBar1.Maximum - 1) && progressBar1.Value != 0) { axWindowsMediaPlayer1.URL = Form1.CaMusica; axWindowsMediaPlayer1.settings.volume = int.Parse(Form1.Volume); OldMusic = axWindowsMediaPlayer1.URL; axWindowsMediaPlayer1.Ctlcontrols.play(); this.Text = (Form1.NameMusic[(Form1.NameMusic.Length - 1)].Substring(0, (Form1.NameMusic[(Form1.NameMusic.Length - 1)].Count() - 4))); }
			Form1.Processo = ".";
		}
		private void Form3_SizeChanged(object sender, EventArgs e)
		{ if (this.Width < 215) this.Size = new Size(215, this.Height); if (this.Height < 175) this.Size = new Size(this.Width, 175); }
		private void Form3_Load(object sender, EventArgs e) { timer1.Tag = 0; MessageBox.Show("If you like the Video full screen, or normal!!\nClick on time in video!!", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information); timer1.Start(); axWindowsMediaPlayer1.URL = Form1.CaMusica; axWindowsMediaPlayer1.settings.volume = int.Parse(Form1.Volume); OldMusic = axWindowsMediaPlayer1.URL; axWindowsMediaPlayer1.Ctlcontrols.play(); this.Text = (Form1.NameMusic[(Form1.NameMusic.Length - 1)].Substring(0, (Form1.NameMusic[(Form1.NameMusic.Length - 1)].Count() - 4))); AuxMusic.Interval = 1; AuxMusic.Start(); timer1.Stop(); Width = 729; Height = 450; try { this.Location = Screen.AllScreens[(Form1.ecra - 1)].WorkingArea.Location; } catch { this.Location = Screen.AllScreens[0].WorkingArea.Location; } this.CenterToScreen(); }
